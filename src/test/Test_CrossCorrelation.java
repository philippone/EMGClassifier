...
//			extractors.add(wamp);
	...
	public final static void main(String[] args) {
		...
		List<LabeledFeatureVector> trainSamples = DataReaderWriter
				.getTrainingLabledFeatureVectors(CCTestParameter.windowSize, CCTestParameter.extractors, null);
		...
		cc.crossValidation(CCTestParameter.gammaStart, CCTestParameter.gammaEnd, CCTestParameter.gammaGranularity, CCTestParameter.CStart,
				CCTestParameter.CEnd, CCTestParameter.CGranularity, CCTestParameter.foldingFactor);
	}
